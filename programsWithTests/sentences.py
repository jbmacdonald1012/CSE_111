...
def get_user_quantity():
    quantity = int(input('Please enter a whole number: '))
    return quantity

def get_user_tense():
    tense = input('Please choose a tense (past, present, future) ')
    return tense
...
def get_verb(quantity, tense):
    ...
    """
    if tense.lower() == 'past' and quantity == 0:
        words = ["drank", "ate", "grew", "laughed", "thought","ran", "slept", "talked", "walked", "wrote"]
    elif tense.lower() == 'past' and quantity == 1:

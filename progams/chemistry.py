...
def main():
    ...
    formula = input('Please enter a chemical compound formula: ')
    # Get the mass of a chemical sample in grams from the user.
    sample_mass = float(input('What\'s the mass of the sample in grams? '))
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    # symbol_quantity_list is part of a dict with key 
    #formula : []
    ...
    for element in symbol_quantity_list:
        ...
        quantity = element[1]
        element_mass = periodic_table_dict[element_symbol]
        atomic_mass = element_mass[ATOMIC_MASS_INDEX]
